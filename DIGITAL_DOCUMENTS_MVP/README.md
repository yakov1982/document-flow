...
Подробный анализ аналогичных СЭД (Лексима, 1С, DocuWare, Alfresco) и план развития — см. **[ROADMAP.md](ROADMAP.md)**.

Кратко: параллельные маршруты, сроки и напоминания, делегирование, шаблоны, OCR, поручения, email-уведомления, номенклатура дел, интеграция с почтой/1С.
