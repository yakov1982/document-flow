...
DIGITAL_DOCUMENTS_MVP/
  ...
  frontend/
    src/               # React SPA
  webmin/
    lexima-dms/        # модуль Webmin для управления настройками
```
...
Для управления настройками через Webmin установите модуль:

```bash
sudo cp -r webmin/lexima-dms /usr/share/webmin/
```

В Webmin появится раздел для настройки JWT, LDAP/AD DS и пути к backend. Подробнее: `webmin/README.md`.
